...
$VERSION = "4.16";   # $Date: 1998/10/12 09:19:51 $
sub Version { $VERSION; }
...
B<Note: This module is now depreciated.  New code should use the
URI module instead, which implements the RFC 2396 behaviour.>
